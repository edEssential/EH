...
ActiveRecord::Schema.define(:version => 20131016104312) do

  create_table "homeposts", :force => true do |t|
    t.datetime "created_at",               :null => false
    t.datetime "updated_at",               :null => false
    t.string   "rightimage_file_name"
    t.string   "rightimage_content_type"
    t.integer  "rightimage_file_size"
    t.datetime "rightimage_updated_at"
    t.string   "latestimage_file_name"
    t.string   "latestimage_content_type"
    t.integer  "latestimage_file_size"
    t.datetime "latestimage_updated_at"
    t.string   "url1"
    t.string   "url2"
    t.string   "url3"
    t.string   "title1"
  ...
  create_table "pdetails", :force => true do |t|
    t.string   "title"
    t.integer  "photo_id"
    t.datetime "created_at",         :null => false
    t.datetime "updated_at",         :null => false
